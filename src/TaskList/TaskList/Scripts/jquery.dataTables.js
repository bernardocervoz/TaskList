...
(/** @lends <global> */function($, window, document, undefined) {
    ...
    var DataTable = function( oInit )
    {
        ...
        function _fnFeatureHtmlLength ( oSettings )
        {
            ...
            $('select', nLength).bind( 'change.DT', function(e) {
                ...
                // Alteração META para não paginar caso não tenha registros - 16/05/2016.
                if (oSettings.aiDisplay.length == 0) {
                    return 0;
                }
        ...
        {
            //_fnBindAction( nNode, {}, function (e) { META
            _fnBindAction(nNode, { settings: oSettings }, function (e) { //META
                /* If the column is not sortable - don't to anything */
                //if ( oSettings.aoColumns[iDataIndex].bSortable === false )
                if (oSettings.aoColumns[iDataIndex].bSortable === false || oSettings.aiDisplay.length == 0) //META
                {
                    return;
                }
        ...
        function _fnBindAction( n, oData, fn )
        {
            $(n)
                .bind('click.DT', oData, function (e) {
                        // Alteração META para não paginar e nem ordenar caso não tenha registros - 16/05/2016.
                    //if (DataTable.settings[DataTable.ext.iApiIndex].aiDisplay.length) {
                    if (oData.settings.aiDisplay.length) {
    ...
    DataTable.defaults = {
        ...
        "oLanguage": {
             ...
             *    } );
             */
            "sInfo": "Exibindo <b>_START_</b> a <b>_END_</b> de <b>_TOTAL_</b> registros",
             ...
             *    } );
             */
            "sInfoEmpty": "Exibindo <b>0</b> a <b>0</b> de <b>0</b> registros",
             ...
             *    } );
             */
            "sLoadingRecords": "<span style='padding:10px; border: 2px solid #c0c0c0;'><img src='" + urlProcessing +"' alt='processando' /> Carregando...</span>",
             ...
             *    } );
             */
            "sProcessing": "<span style='padding:10px; border: 2px solid #c0c0c0;'><img src='" + urlProcessing +"' alt='processando' /> Processando...</span>",
    ...
    $.extend( DataTable.ext.oPagination, {
        ...
        "two_button": {
            ...
            "fnInit": function ( oSettings, nPaging, fnCallbackDraw )
            {
                ...
                //oSettings.oApi._fnBindAction( nPrevious, {action: "previous"}, fnClickHandler ); // META
                //oSettings.oApi._fnBindAction( nNext,     {action: "next"},     fnClickHandler );
                oSettings.oApi._fnBindAction( nPrevious, {settings: oSettings, action: "previous"}, fnClickHandler );
                oSettings.oApi._fnBindAction( nNext,     {settings: oSettings, action: "next"},     fnClickHandler );
        ...
        "full_numbers": {
            ...
            "fnInit": function ( oSettings, nPaging, fnCallbackDraw )
            {
                ...
                //oSettings.oApi._fnBindAction( nFirst, {action: "first"},    fnClickHandler ); // META
                //oSettings.oApi._fnBindAction( nPrev,  {action: "previous"}, fnClickHandler );
                //oSettings.oApi._fnBindAction( nNext,  {action: "next"},     fnClickHandler );
                //oSettings.oApi._fnBindAction(nLast, { action: "last" }, fnClickHandler);

                oSettings.oApi._fnBindAction(nFirst, { settings: oSettings, action: "first" }, fnClickHandler);
                oSettings.oApi._fnBindAction(nPrev, { settings: oSettings, action: "previous" }, fnClickHandler);
                oSettings.oApi._fnBindAction(nNext, { settings: oSettings, action: "next" }, fnClickHandler);
                oSettings.oApi._fnBindAction(nLast, { settings: oSettings, action: "last" }, fnClickHandler);
            ...
            "fnUpdate": function ( oSettings, fnCallbackDraw )
            {
                ...
                var fnBind = function (j) {
                    ...
                    //oSettings.oApi._fnBindAction( this, {"page": j+iStartButton-1}, function(e) { // META
                    oSettings.oApi._fnBindAction(this, {settings: oSettings, "page": j + iStartButton - 1 }, function (e) {
